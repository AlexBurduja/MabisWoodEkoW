...
// import photo from '../../../public/pozaSacPeleti.jpg'
    ...
    <section className='missionStoryWrap'>
        <section className='ourMission'>
            <div className='ourMission_text'>
                ...
                <p>
                    La Mabis Wood Eko, ne dedicam misiunii de a produce peleti ecologici de cea mai inalta calitate. Fiecare pas in procesul nostru este ghidat de un angajament profund fata de mediu si sustenabilitate. Folosim exclusiv materiale de top, atent selectionate si verificate personal pentru a asigura un standard inalt de calitate si puritate. Lucram indeaproape doar cu furnizori de incredere, care impartasesc valorile noastre si se angajeaza la practici responsabile. Aspiram sa fim un model de ecologie si sustenabilitate în industrie, reducand impactul asupra mediului si promovand un viitor mai verde pentru toti. Alegand Mabis Wood Eko, nu alegeti doar peleti, ci un angajament pentru un mediu curat si sanatos.
                </p>
            </div>

            <div className='ourMission_photo'>
                <img src='/pozaSacPeleti.jpg' height={350}></img>
            </div>
        </section>
